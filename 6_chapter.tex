...
\paragraph{\texorpdfstring{CO$_2$ concentration}{CO2 concentration}}
...
\begin{figure}[!htbp]
	...
	\end{tikzpicture}
		\subfloat[][\mbox{V1-1w}]		
	{\hspace*{-3.2cm}\includegraphics[width=0.135\textheight, trim= 0.00cm 0.1cm 5cm 0.45cm, clip]{images/ACR/ACR_V1-1w}}\hspace*{0.1cm}
